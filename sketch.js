...
new p5(function (p) {
  ...
  p.draw = function () {
    ...
    // RESUME is a separate gesture from PAUSE — wire it explicitly
    // (Game.handleGesture already handles it, this comment is for clarity)
  ...
  function _renderCamPreview() {
    ...
    // Overlay hand skeleton + fingertip dots for all detected hands
